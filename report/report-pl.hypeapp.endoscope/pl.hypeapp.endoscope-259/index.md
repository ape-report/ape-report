...
```
// java.lang.RuntimeException: Unable to resume activity {pl.hypeapp.endoscope/pl.hypeapp.endoscope.ui.activity.StartStreamActivity}: java.lang.IllegalStateException: You must disable foreground dispatching while your activity is still resumed
