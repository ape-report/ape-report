...
```
// java.lang.NullPointerException: Attempt to read from field 'android.graphics.Bitmap pt.isec.tp.am.Background.bitmap' on a null object reference
// 	at pt.isec.tp.am.Surface.onDraw(Surface.java:123)
// 	at android.view.View.draw(View.java:16184)
// 	at android.view.SurfaceView.draw(SurfaceView.java:341)
